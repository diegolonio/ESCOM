<?php
    ...
    $productos = $conexion->prepare("SELECT tw.producto.IdProducto, tw.producto.Imagen, tw.producto.Nombre, tw.producto.Descripcion, tw.producto.Precio, tw.producto.Valoracion FROM tw.producto WHERE tw.producto.IdCategoria = 1");
    $productos->execute();
...
<head>
    ...
    <title>Mercury | Electrónicos</title>
